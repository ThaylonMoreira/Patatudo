...
class _PetEditPageState extends State<PetEditPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            Text(widget.pet.isNull ? 'Adicionar Novo Pet' : 'Alteração de Pet'),
      ),
      body: Container(
            ...
            return ListView(
              children: [
                TextFormField(
                  ...
                  onChanged: (value) {
                    context.read<PetEditBloc>().add(PetNameChanged(value));
                  },
                ...
                DropdownButtonFormField<PetType>(
                  ...
                  onChanged: (newValue) {
                    if (newValue != null) {
                      context.read<PetEditBloc>().add(PetTypeChanged(newValue));
                    }
                  },
                ...
                TextFormField(
                  ...
                  onChanged: (value) {
                    context.read<PetEditBloc>().add(PetBreedChanged(value));
                  },
                  onTapOutside: (_) => context.closeKeyboard(),
                ),
                const SizedBox(height: 16.0),
                TextFormField(
                  ...
                  onChanged: (value) {
                    context.read<PetEditBloc>().add(PetAgeChanged(value));
                  },
                  onTapOutside: (_) => context.closeKeyboard(),
                ),
                const SizedBox(height: 16.0),
                TextFormField(
                  ...
                  onChanged: (value) {
                    context.read<PetEditBloc>().add(PetWeightChanged(value));
                  },
                  onTapOutside: (_) => context.closeKeyboard(),
                ),
                const SizedBox(height: 16.0),
                TextFormField(
                  ...
                  onChanged: (value) {
                    context.read<PetEditBloc>().add(PetBirthdayChanged(value));
                  },
                  onTapOutside: (_) => context.closeKeyboard(),
                ),
                const SizedBox(height: 16.0),
                TextFormField(
                  ...
                  onChanged: (value) {
                    context.read<PetEditBloc>().add(PetGenderChanged(value));
                  },
                  onTapOutside: (_) => context.closeKeyboard(),
                ),
                const SizedBox(height: 16.0),
                TextFormField(
                  ...
                  onChanged: (value) {
                    context.read<PetEditBloc>().add(PetNotesChanged(value));
                  },
                  onTapOutside: (_) => context.closeKeyboard(),
                ),
                const SizedBox(height: 16.0),
                ElevatedButton(
                  onPressed: state.formValidator &&
                      ...
                      ? () {
                          context.read<PetEditBloc>().add(PetEditSubmitted(
                  ...
                  child: state.status == PetEditStatus.submitting
                      ...
                      : Text(widget.pet.isNull ? 'Criar pet' : 'Atualizar pet'),
                ),
              ],
            );
          },
