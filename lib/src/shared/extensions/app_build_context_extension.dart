...
extension AppBuildContextEntension<T> on BuildContext {
  ...
  double get smallGap => min(16, shortSide * 0.02);
  double get mediumGap => min(24, shortSide * 0.06);
  double get largeGap => min(48, shortSide * 0.12);
